...
class TestApiGeoCat(unittest.TestCase):
    ...
    def test_load_pre_saved_metadata(self, mock_load):
        ...
        self.assertEqual(
            self.api.preSavedMetadata["testId"]["en"]["title"], "Test Title"
        )
    ...
    def test_extract_uuid_from_valid_url_of_typeA(self):
        ...
        self.assertEqual(
            self.api.extractUuid(url), "a7109ba7-9dcc-46d6-829f-c94b2214a1e5"
        )
    ...
    def test_extract_uuid_from_valid_url_of_typeB(self):
        ...
        self.assertEqual(
            self.api.extractUuid(url), "0d216c1b-2998-4eb9-a47b-ac88aafb7271"
        )
